...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-ijunes-laundrytimer.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-ijunes-laundrytimer)

This repository contains the source code for the [LaundryTimer](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.ijunes.laundrytimer).

Please see the [issues](https://github.com.ijunes.laundrytimer/com-ijunes-laundrytimer/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about LaundryTimer? Ask away on the [com-ijunes-laundrytimer discussion forum](https://groups.google.com/forum/#!forum/com-ijunes-laundrytimer).

<a href="https://play.google.com/store/apps/details?id=com.ijunes.laundrytimer" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.ijunes.laundrytimer__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.ijunes.laundrytimer__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.ijunes.laundrytimer.R__) will now be renamed
...
signed with a different key.  Manually uninstall LaundryTimer from your device and
...
LaundryTimer is a result of a template project I've developed over the years as well as
...
LaundryTimer is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.ijunes.laundrytimer/com-ijunes-laundrytimer/contributors) on
...
[pull requests](https://github.com.ijunes.laundrytimer/com-ijunes-laundrytimer/pulls).

...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.ijunes.laundrytimer";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "LaundryTimer";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.ijunes.laundrytimer.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.ijunes.laundrytimer.";
